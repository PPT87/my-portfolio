              ...
              <div className='picture-wrapper'></div>
                <div className='title'>
                  <h3>Software Engineer | Mechanical Engineer</h3>
                    <p>I am Full Stack Developer with 8+ years Automotive Project Management experience. I have developed web applications using languages such as JavaScript and Python along with frameworks including Express.js and Django. </p> <br />
